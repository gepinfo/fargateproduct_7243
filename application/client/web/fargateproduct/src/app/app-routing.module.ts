...
{ path : 'cstudent', loadChildren: () => import('./cstudent/cstudent.module').then(m => m.CstudentModule), canActivate: [AuthGuard] } , 
{ path : 'ccollege', loadChildren: () => import('./ccollege/ccollege.module').then(m => m.CcollegeModule), canActivate: [AuthGuard] } , 
{ path : 'cempform', loadChildren: () => import('./cempform/cempform.module').then(m => m.CempformModule), canActivate: [AuthGuard] } , 
{ path : 'bankdetails', loadChildren: () => import('./bankdetails/bankdetails.module').then(m => m.BankdetailsModule), canActivate: [AuthGuard] } , 
];
